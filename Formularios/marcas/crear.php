                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nom_marca" name="nom_marca" placeholder="Nombre de la marca" require>
                            </div>
                            <div class="mb-3">
                                <label for="contrato_exp" class="form-label">Expiracion del contrato</label>
                                <input type="datetime-local" class="form-control" id="contrato_exp" name="contrato_exp" placeholder="Expiracion del contrato" require>
                            </div>
                            <div class="mb-3">
                                <label for="precio_contrato" class="form-label">Precio por el contrato</label>
                                <input type="text" class="form-control" id="precio_contrato" name="precio_contrato" placeholder="Precio por el contrato" require>
                            </div>
                            <div class="mb-3">
                                <label for="cant_prod_tiendas" class="form-label">Cantidad de productos en tienda</label>
                                <input type="text" class="form-control" id="cant_prod_tiendas" name="cant_prod_tiendas" placeholder="Cantida de productos en tiendas" require>
                            </div>
                            <div class="mb-3">
                                <label for="vision" class="form-label">Vision</label>
                                <input type="text" class="form-control" id="vision" name="vision" placeholder="Vision de la marca" require>
                            </div>
                            <div class="mb-3">
                                <label for="total_ventas" class="form-label">Total de ventas</label>
                                <input type="text" class="form-control" id="total_ventas" name="total_ventas" placeholder="Total de ventas" require>
                            </div>
                            <div class="mb-3">
                                <label for="estado" class="form-label">Estado</label>
                                <input type="text" class="form-control" id="estado" name="estado" placeholder="Estado de la marca" require>
                            </div>
