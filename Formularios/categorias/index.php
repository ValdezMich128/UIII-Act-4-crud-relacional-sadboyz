            ...
            <table class="table table-hover">
                <thead class="table-dark">
                    <tr>
                        ...
                        <th scope="col">Gmail Sucursal</th>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <th scope="row"><?php echo $resultado['calle'] ?></th>
                            <th scope="row"><?php echo $resultado['num_exterior'] ?></th>
                            <th scope="row"><?php echo $resultado['telefono'] ?></th>
                            <th scope="row"><?php echo $resultado['id_empleado'] ?></th>
                            <th scope="row"><?php echo $resultado['gmail'] ?></th>
                            <th scope="row">
                                <a href="<?php echo base_url; ?>Formularios/categorias/actualizar.php?Id=<?php echo $resultado['id_sucursal'] ?>" class="btn btn-outline-warning">
                                    <i class="fa-solid fa-pen-to-square fa-beat"></i>
                                </a>
                                <a href="<?php echo base_url; ?>CRUDC/eliminarDatos.php?Id=<?php echo $resultado['id_sucursal'] ?>" class="btn btn-outline-danger">
